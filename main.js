...
$("#base-icon-control ,#close-base-icon").click(function(){
    ...
    if(left=="0px"){
     ...
     $(".container-setting").animate({left:`-${width}px`},600)
 ...
 console.log(a);
      ...
      $(".container-setting").animate({left:`0px`},600)
      // animation about links at side navbar start from bottom to top
      for (let i = 0; i < 5; i++) {
         $(".nav-item ul li a").eq(i).animate({
             top: 0
  ...
  let rowa= document.getElementById("Row")
   ...
   $("#base-icon-control").show(10)
let cartona=`
<div class="container special-width mt-3">
                        <div class="row mt-5">
                            <div class="col-md-6 search-media">
                                <input id="searchName" onkeyup="searchByName(this.value)" class="form-control bg-white text-white" type="text" placeholder="Search By Name">
                              </div>
                             
                              <div class="col-md-6 search-media">
                                <input  maxlength="1" id="searchF" onkeyup="searchByFirstLet(this.value)"  class="form-control bg-white text-white" type="text" placeholder="Search By First Letter">
                              </div>
...
let contact=''
    ...
    $('#exampleModal').modal('hide');
       ...
       $("#base-icon-control").show(10)
        ...
        contact=document.getElementById("nameInput") 
